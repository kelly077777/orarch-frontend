...
function DocumentSlidePanel({ doc, projectId, onClose, user, allDocs = [] }) {
  ...
  return (
    <>
     ...
     <div style={{ position:'fixed', top:0, right:0, width:'82vw', height:'100vh', background:'#fff', zIndex:201, display:'flex', flexDirection:'column', boxShadow:'-4px 0 24px rgba(0,0,0,0.15)', animation:'slideIn 0.25s ease-out' }}>
